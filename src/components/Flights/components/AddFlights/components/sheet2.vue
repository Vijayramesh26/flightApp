    ...
    <div class="">
        <v-card class=" elevation-0 rounded-lg mt-2">
            <v-row>
                ...
                <v-col cols="12" md="4">
                    <v-autocomplete :items="addFlights.timezones" v-model="arrivalTimezone" label="Timezone*" outlined
                        class="rounded-lg"></v-autocomplete>
                </v-col>
            </v-row>
        </v-card>
            ...
            <v-row>
                ...
                <v-col cols="12" class="mt-n5">
                    ...
                    <v-btn-toggle v-model="repeatOnDays" multiple tile class="mb-2 rounded-lg">
                        <v-btn v-for="day in addFlights.days" :key="day" :value="day" class="rounded-lg pa-4 mx-2"
                            :class="{
